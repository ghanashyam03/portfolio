...
export function OrbitalNav() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-1.5 p-1.5 rounded-[2px] bg-[#070913]/85 backdrop-blur-xl border border-[rgba(255,255,255,0.12)] shadow-[0_8px_32px_rgba(0,0,0,0.8)]">
        {/* System Telemetry Pill */}
        <div className="flex items-center gap-2 px-3 py-1.5 border-r border-[rgba(255,255,255,0.1)] text-[10px] font-mono text-[#22D3EE]">
