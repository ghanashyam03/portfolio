...
import { Download, Briefcase, GraduationCap, Wrench, Award, CheckCircle2 } from 'lucide-react';
    ...
    <div className="w-full max-w-5xl mx-auto px-6 sm:px-12 pt-32 pb-24 text-[#F5F7FF]">
      ...
      >
        <div>
          ...
          <p className="font-inter text-base text-[#8B93B0]">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-5 py-3 bg-[#FB923C] text-[#05060A] font-space font-bold text-xs tracking-wider uppercase rounded-[2px] border-hud hover:bg-[#FB923C]/90 hover:shadow-[0_0_20px_rgba(251,146,60,0.5)] transition-all duration-300 shrink-0 self-start sm:self-auto"
        >
      ...
      >
        ...
        <div className="hud-card p-8 sm:p-10 border-hud">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6 border-b border-[rgba(255,255,255,0.08)] pb-4">
            ...
            <span className="font-mono text-xs text-[#FB923C] bg-[#05060A]/80 px-3 py-1 border-hud rounded-[2px] self-start sm:self-auto">
              April 2025 – Present
            </span>
          </div>

          <ul className="space-y-4 font-inter text-sm sm:text-base text-[#8B93B0] leading-relaxed">
      ...
      >
        ...
        <div className="hud-card p-8 sm:p-10 border-hud">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
            ...
            <span className="font-mono text-xs text-[#22D3EE] bg-[#05060A]/80 px-3 py-1 border-hud rounded-[2px] self-start sm:self-auto">
              2021 – 2025
            </span>
          </div>

          <div className="mt-4 pt-4 border-t border-[rgba(255,255,255,0.08)] flex items-center gap-3">
            <span className="font-mono text-xs text-[#8B93B0] uppercase tracking-wider">
              ACADEMIC SCORE:
            </span>
      ...
      >
        ...
        <div className="space-y-6">
          {SKILL_GROUPS.map((group) => (
            <div key={group.category} className="hud-card p-6 border-hud">
              ...
              <div className="flex flex-wrap gap-2.5">
                {group.skills.map((skill) => (
                  <span
                    key={skill}
                    className="font-mono text-xs px-3 py-1.5 bg-[#05060A]/80 text-[#F5F7FF] border border-[rgba(255,255,255,0.12)] rounded-[2px] hover:border-[#22D3EE]/50 hover:text-[#22D3EE] transition-colors"
                  >
                    {skill}
                  </span>
                ))}
      ...
      >
        ...
        <div className="hud-card p-8 sm:p-10 border-hud space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-inter text-sm text-[#8B93B0] leading-relaxed">
